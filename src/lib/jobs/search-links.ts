 ...
 *
 * Pure string building with no network, so it always works and is easy to test.
 */
...
export function buildAllSearchLinks(criteria: SearchCriteria): SearchLink[] {
  ...
  // Indeed has the broadest local and professional coverage.
  {
  ...
  // LinkedIn is strong for professional roles.
  {
  ...
  // ZipRecruiter has broad US coverage.
  {
  ...
  // Snagajob covers local hourly and shift work.
  {
