...
ALTER TABLE "resume_job_fit" ADD COLUMN IF NOT EXISTS "status" text DEFAULT 'completed' NOT NULL;--> statement-breakpoint
ALTER TABLE "resume_job_fit" ADD COLUMN IF NOT EXISTS "error_summary" text;--> statement-breakpoint
ALTER TABLE "resume_job_fit" DROP CONSTRAINT IF EXISTS "resume_job_fit_status_check";--> statement-breakpoint
