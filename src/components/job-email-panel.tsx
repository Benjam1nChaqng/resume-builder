    ...
    <section className="rounded-lg border border-neutral-200 p-5 dark:border-neutral-800">
      ...
      <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-end">
        ...
        <Button type="button" onClick={handleDraft} disabled={isPending}>
          {isPending ? "Writing…" : drafted ? "Re-draft" : "Draft email"}
        </Button>
      </div>
      ...
      {drafted ? (
        <div className="mt-5 space-y-4">
          ...
          <p className="text-xs text-neutral-400">
            Tip: attach your resume PDF in your email before sending — download it
            from the tailored-resume section above.
          </p>
        </div>
      ) : null}
    </section>
