...
6. User can edit any field inline. Saves auto-persist.
...
- resume: id, userId, title, isDefault, createdAt, updatedAt
...
- job: id, userId, sourceUrl, title, company, description, requirements (jsonb), scrapedAt — for v0.2
- application: id, userId, jobId, resumeId, status, appliedAt — for v0.2

All timestamps use Postgres TIMESTAMP WITH TIME ZONE. IDs are UUIDs (use Postgres gen_random_uuid()).
...
Live URL: https://resume-builder-theta-rust.vercel.app
